...
function ProductInfoAll({match}) {
      const [results, setResults] = useState([])

      useEffect(() =>{
      const url =`https://sleepy-earth-86694.herokuapp.com/products/${match.params.id}`
      axios.get(url)
      ...
      <div>
        ...
        <section className='bg-gray'>
            ...
            <p className='text-base mt-10'>{results.description}</p>
